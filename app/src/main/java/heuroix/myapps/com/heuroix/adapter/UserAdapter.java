...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.MyViewHolder>
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.phone.setText(contact.getNotelp());

        if(contact.getUserimage().equals("empty")){
            ...
            Glide.with(context)
                    .load("http://heuroix.000webhostapp.com/userImage/" + contact.getUserimage())
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (User row : contactList) {
                        ...
                        if (row.getNama().toLowerCase().contains(charString.toLowerCase()) || row.getNotelp().contains(charSequence)) {
